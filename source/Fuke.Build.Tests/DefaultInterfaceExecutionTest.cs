...
namespace Fuke.Common.Tests.Execution;
...
public class DefaultInterfaceExecutionTest
{
    ...
    private class ParameterBuild : FukeBuild, IParameterInterface { }

    private class TestBuild : FukeBuild, ITestBuild
    {
        public Target E => _ => _
    ...
    private class MultipleInheritanceTestBuild : FukeBuild, IInheritedTestBuild
    {
    ...
    private class InvalidDependencyTypeTestBuild : FukeBuild
    {
        public Target E => _ => _
            .DependsOn<ITestBuild>(x => x.A)
            .Executes(() => { });
    ...
    private class NonPublicTargetTestBuild : FukeBuild, ITestBuild
    {
        private Target D => _ => _
            .Executes(() => { });
    }

    private class DuplicatedTargetTestBuild : FukeBuild, ITestBuild, IDuplicatedTargetBuild
    {
    }

    private class OverriddenDuplicatedTargetTestBuild : FukeBuild, ITestBuild, IDuplicatedTargetBuild
    {
        public Target D => _ => _
            .Executes(() => { });
    }
    ...
    private class TestBuildWithDeclaringAndImplementingComponent : FukeBuild, IImplementingComponent
    {
    }

    private interface IDeclaringComponent : IFukeBuild
    {
        Target Foo { get; }
    }
