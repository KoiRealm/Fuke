...
#pragma warning disable CS0649 // Field is never assigned to, and will always have its default value
    private class EmptyBuild : FukeBuild
    {
    }

    private class TargetBuild : FukeBuild, ITargetComponent
    {
    ...
    private interface ITargetComponent : IFukeBuild
    {
    ...
    private class ParameterBuild : FukeBuild, IParameterComponent
    {
    ...
    private interface IParameterComponent : IFukeBuild
    {
    ...
    private class CustomParameterAttributeBuild : FukeBuild
    {
