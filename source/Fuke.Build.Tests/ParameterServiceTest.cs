...
public class ParameterServiceTest
{
    ...
    public void TestValueSet()
    {
        ...
        ParameterService.GetParameterValueSet(GetMemberInfo(() => FukeBuild.Verbosity), instance: null)
...
#pragma warning disable CS0649
    private class TestBuild : FukeBuild, ITestComponent
    {
    ...
    private interface ITestComponent : IFukeBuild
    {
