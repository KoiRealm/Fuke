...
public static class PathConstruction
{
    ...
    [CodeTemplate(
        searchTemplate: "PathConstruction.GetRelativePath($expr{'Fuke.Common.IO.AbsolutePath', true}$, $args$)",
    ...
    [CodeTemplate(
        searchTemplate: "GetRelativePath($expr{'Fuke.Common.IO.AbsolutePath', true}$, $args$)",
        ReplaceTemplate = "$expr$.GetRelativePathTo($args$)",
        ReplaceMessage = "Replace with $expr$.GetRelativePathTo($args$)",
        Message = $"WARNING: {nameof(GetRelativePath)} is obsolete")]
    ...
    [CodeTemplate(
        searchTemplate: "PathConstruction.IsDescendantPath($expr{'Fuke.Common.IO.AbsolutePath', true}$, $args$)",
    ...
    [CodeTemplate(
        searchTemplate: "IsDescendantPath($expr{'Fuke.Common.IO.AbsolutePath', true}$, $args$)",
        ReplaceTemplate = "$expr$.Contains($args$)",
        ReplaceMessage = "Replace with $expr$.Contains($args$)",
        Message = $"WARNING: {nameof(IsDescendantPath)} is obsolete")]
