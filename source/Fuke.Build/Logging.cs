...
public static class Logging
{
    ...
    public static void Configure(IFukeBuild build = null)
    {
        if (build != null)
        {
    ...
    public static LoggerConfiguration ConfigureFilter(this LoggerConfiguration configuration, [CanBeNull] IFukeBuild build)
    {
        if (build == null)
    ...
    public static LoggerConfiguration ConfigureConsole(this LoggerConfiguration configuration, [CanBeNull] IFukeBuild build)
    {
        return configuration
    ...
    public static LoggerConfiguration ConfigureHost(this LoggerConfiguration configuration, [CanBeNull] IFukeBuild build)
    {
        if (build == null)
            return configuration;
    ...
    public static LoggerConfiguration ConfigureInMemory(this LoggerConfiguration configuration, [CanBeNull] IFukeBuild build)
    {
        if (build == null)
            return configuration;
    ...
    public static LoggerConfiguration ConfigureFiles(this LoggerConfiguration configuration, [CanBeNull] IFukeBuild build)
    {
    ...
    private static void DeleteOldLogFiles(IFukeBuild build)
    {
