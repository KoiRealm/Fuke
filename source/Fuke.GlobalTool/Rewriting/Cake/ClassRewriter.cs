...
internal class ClassRewriter : SafeSyntaxRewriter
{
    ...
    private static string[] NamespaceImports =>
        new[]
        {
            ...
            "System.Xml",
            "Fuke.Common",
            "Fuke.Common.Execution",
            "Fuke.Common.IO",
            "Fuke.Common.ProjectModel",
            "Fuke.Common.Tooling",
            "Fuke.Common.Tools.DotNet",
            "Fuke.Common.Tools.GitVersion",
            "Fuke.Common.Tools.SignTool",
            "Fuke.Common.Utilities.Collections",
        };
    ...
    public override SyntaxNode VisitCompilationUnit(CompilationUnitSyntax node)
    {
        ...
        var baseTypes = SeparatedList(new BaseTypeSyntax[] { SimpleBaseType(ParseTypeName(nameof(FukeBuild))) });
