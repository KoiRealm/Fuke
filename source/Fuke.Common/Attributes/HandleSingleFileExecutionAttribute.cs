...
public class HandleSingleFileExecutionAttribute : BuildExtensionAttributeBase, IOnBuildCreated
{
    ...
    private void InstallDotNetRuntime()
    {
        ...
        var installLocation = Constants.GlobalFukeDirectory / "dotnet-runtime" / (version ?? "current");
    ...
    private AbsolutePath ScriptFile => Constants.GlobalFukeDirectory / ScriptFileName;
