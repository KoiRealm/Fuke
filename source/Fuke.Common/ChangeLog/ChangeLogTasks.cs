...
namespace Fuke.Common.ChangeLog;
...
public static class ChangelogTasks
{
    ...
    {
        Log.Information("Finalizing {File} for {Tag} ...", PathConstruction.GetRelativePath(FukeBuild.RootDirectory, changelogFile.Path), tag);
    ...
    {
        Log.Information("Finalizing {File} for {Tag} ...", PathConstruction.GetRelativePath(FukeBuild.RootDirectory, changelogFile), tag);
