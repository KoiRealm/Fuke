...
using static Fuke.Common.Tools.Docker.DockerTasks;
...
{
    private static readonly AbsolutePath WindowsRootDirectory = @"C:\fuke";
    private static readonly AbsolutePath WindowsNuGetDirectory = @"C:\nuget";

    private static readonly AbsolutePath UnixRootDirectory = @"/fuke";
        ...
        AbsolutePath tempDirectory)
    {
        var customEnvironmentVariables = new Dictionary<string, string>()
            ...
            .AddPair("FUKE_ROOT", rootDirectory)
