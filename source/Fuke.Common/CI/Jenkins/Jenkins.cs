...
namespace Fuke.Common.CI.Jenkins;
...
public class Jenkins : Host, IBuildServer
{
    ...
    /// <summary>
    /// The current build tag, such as "jenkins-fuke-14".
    /// </summary>
    ...
    /// <summary>
    /// The base name of the current job, such as "Fuke".
    /// </summary>
    ...
    /// <summary>
    /// The  name of the current job, such as "Fuke".
    /// </summary>
