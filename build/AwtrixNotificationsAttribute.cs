    ...
    IOnBuildFinished
{
    ...
    public string MqttHost => EnvironmentInfo.GetVariable("FUKE_AWTRIX_MQTT_HOST");
    public int? MqttPort => EnvironmentInfo.GetVariable<int?>("FUKE_AWTRIX_MQTT_PORT").NotNull();
    public string MqttTopicPrefix => EnvironmentInfo.GetVariable("FUKE_AWTRIX_MQTT_PREFIX").NotNullOrWhiteSpace();
